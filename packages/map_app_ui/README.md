...
Map App UI package containing a general design system.
...
│   │       ├── colors
│   │       ├── icons
│   │       │      ├── map_app_icons_dark.dart
│   │       │      ├── map_app_icons_light.dart
│   │       │      └── map_app_icons.dart 
│   │       ├── spacing
│   │       ├── theme
│   │       ├── typography
│   │       └── widgets
│   │             ├── map_app_app_bar.dart
│   │             ├── map_app_outlined_button.dart
│   │             └── map_app_text_field.dart 
│   ├── map_app_ui.dart
│   ├── .gitignore
...
```
2) In `map_app_icons_light.dart` add the icon with its color respectively of the theme. 
...
3) In `map_app_icons_dark.dart` add the icon with its color respectively of the theme. 
